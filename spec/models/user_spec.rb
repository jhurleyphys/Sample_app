...
describe User do
	before { @user = User.new(name: "Example User", email: "user@example.com", password: "Xpress", password_confirmation: "Xpress") }
	subject { @user }
	...
	describe "Case insenitive when email address is already used" do
		before do
			user_with_duplicate_email = @user.dup 
